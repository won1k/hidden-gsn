...
cmd:text("")
cmd:option('-data_file','convert/ptb-s2s-train.hdf5', [[Path to the training *.hdf5 file from preprocess.py]])
cmd:option('-val_data_file','convert/ptb-s2s-val.hdf5', [[Path to validation *.hdf5 file from preprocess.py]])
cmd:option('-savefile', 'checkpoint/ptb-s2s', [[Savefile name (model will be saved as
...
cmd:option('-attn', 0, [[If = 1, use attention on the decoder side. If = 0, it uses the last
